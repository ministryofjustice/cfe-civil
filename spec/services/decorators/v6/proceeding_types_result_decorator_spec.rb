    ...
    RSpec.describe ProceedingTypesResultDecorator do
      ...
      let(:results) do
        assessment.proceeding_types.map do |pt|
          x = create :assessment_eligibility, assessment:, proceeding_type_code: pt.ccms_code, assessment_result: "eligible"
          ProceedingTypeResult.new(proceeding_type: pt, eligibility: x)
        end
      end
