    ...
    context "AssessmentProceedingTypeSummarizer" do
      it "calls AssessmentProceedingTypeSummarizer for each proceeding type code" do
        expect(Summarizers::AssessmentProceedingTypeSummarizer)
          .to receive(:call)
                .with(assessment:, proceeding_type_code: "DA003", receives_qualifying_benefit: false, receives_asylum_support: false,
                      gross_income_assessment_result: "pending", disposable_income_result: "pending")
        expect(Summarizers::AssessmentProceedingTypeSummarizer)
          .to receive(:call).with(assessment:, proceeding_type_code: "SE014", receives_qualifying_benefit: false, receives_asylum_support: false,
                                  gross_income_assessment_result: "pending", disposable_income_result: "pending")
        summarizer
      end
    end
    ...
    context "result summarizer" do
      before do
        ...
        allow(Summarizers::AssessmentProceedingTypeSummarizer)
          .to receive(:call)
                                                                    .with(assessment:, proceeding_type_code: "DA003",
                                                                          receives_qualifying_benefit: false, receives_asylum_support: false, gross_income_assessment_result: "pending", disposable_income_result: "pending")
        allow(Summarizers::AssessmentProceedingTypeSummarizer)
          .to receive(:call)
                .with(assessment:, proceeding_type_code: "SE014", receives_qualifying_benefit: false, receives_asylum_support: false,
                      gross_income_assessment_result: "pending", disposable_income_result: "pending")
      end
