...
RSpec.describe Calculators::EmploymentMonthlyValueCalculator do
  describe ".call" do
    ...
    context "when there are employment payments" do
      ...
      let(:payments) do
        [
          monthly_equiv_payment_data.new(date: Date.yesterday, benefits_in_kind_monthly_equiv: 10, gross_income_monthly_equiv: 90, national_insurance_monthly_equiv: -10, tax_monthly_equiv: -20, prisoner_levy_monthly_equiv: 0.0, student_debt_repayment_monthly_equiv: 0.0),
          monthly_equiv_payment_data.new(date: Date.current, benefits_in_kind_monthly_equiv: 10, gross_income_monthly_equiv: 490, national_insurance_monthly_equiv: -20, tax_monthly_equiv: -50, prisoner_levy_monthly_equiv: 0.0, student_debt_repayment_monthly_equiv: 0.0),
        ]
      end
        ...
        it "updates the monthly gross income, national insurance, and tax to " \
          ...
          expect(described_class.call(employment, submission_date, payments).values)
            .to eq(
              ...
              monthly_student_debt_repayment: 0.0,
              monthly_tax: -50,
            )
        end
