      ...
      context "when mocking Threshold values" do
        ...
        context "under 15" do
          context "with income" do
            let(:dependant) { build :dependant, :under15, amount: 25.00, submission_date: }
          ...
          context "without income" do
            let(:dependant) { build :dependant, :under15, amount: 0.0, submission_date: }
        ...
        context "15 years old" do
          context "with income" do
            let(:dependant) { build :dependant, :aged15, amount: 25.50, submission_date: }
          ...
          context "with income greater than the allowance" do
            let(:dependant) { build :dependant, :aged15, amount: 250.00, submission_date: }
          ...
          context "without income" do
            let(:dependant) { build :dependant, :aged15, amount: 30.55, submission_date: }
        ...
        context "16 or 17 years old" do
          context "in full time education" do
            ...
            context "with  no income" do
              let(:dependant) { build :dependant, :aged16or17, amount: 0.0, in_full_time_education: true, submission_date: }
            ...
            context "with income" do
              let(:dependant) { build :dependant, :aged16or17, amount: 100.01, in_full_time_education: true, submission_date: }
            ...
            context "with income greater than the allowance" do
              let(:dependant) { build :dependant, :aged16or17, amount: 350.00, in_full_time_education: true, submission_date: }
          ...
          context "not in full time education" do
            context "with  no income" do
              let(:dependant) { build :dependant, :aged16or17, amount: 0.0, in_full_time_education: false, submission_date: }
            ...
            context "with income" do
              let(:dependant) { build :dependant, :aged16or17, amount: 100.22, in_full_time_education: false, submission_date: }
        ...
        context "over 18 years old" do
          context "with no income" do
            context "with capital assets < threshold" do
              let(:dependant) { build :dependant, :over18, amount: 0.0, assets_value: 4_470, submission_date: }
            ...
            context "with capital assets > threshold" do
              let(:dependant) { build :dependant, :over18, amount: 0.0, assets_value: 8_100, submission_date: }
          ...
          context "with capital assets < threshold" do
            let(:dependant) { build :dependant, :over18, amount: 203.37, assets_value: 5_000, submission_date: }
