    ...
    describe "#call" do
      ...
      context "property_assessment" do
        ...
        it "instantiates and calls the Property Assessment service" do
          allow(Assessors::PropertyAssessor).to receive(:call).and_return([instance_double(Assessors::PropertyAssessor::PropertyData,
                                                                                           result: instance_double(Assessors::PropertyAssessor::Result,
                                                                                                                   smod_allowance: 0,
                                                                                                                   assessed_equity: 23_000))])
