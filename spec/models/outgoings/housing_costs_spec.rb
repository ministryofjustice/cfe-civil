  ...
  RSpec.describe HousingCost do
    describe "allowable_amount" do
      context "board_and_lodging" do
        it "returns half the amount" do
          outgoing = build :housing_cost_outgoing, housing_cost_type: "board_and_lodging", amount: 135.43
      ...
      context "rent" do
        it "returns the full amount" do
          outgoing = build :housing_cost_outgoing, housing_cost_type: "rent", amount: 207.38
      ...
      context "mortgage" do
        it "returns the full amount" do
          outgoing = build :housing_cost_outgoing, housing_cost_type: "mortgage", amount: 99.98
    ...
    describe "#client id" do
      it "returns the value" do
        outgoing = build :housing_cost_outgoing, amount: 127.33, payment_date: Date.new(2019, 3, 2), client_id: "55b31f30-a198-45bd-9a43-a4e5b66fa42e"
