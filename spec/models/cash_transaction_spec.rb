...
describe CashTransaction do
  ...
  describe "by_operation_and_category" do
    it "display all the cash transactions for benefits 1" do
      expect(described_class.by_operation_and_category(assessment1.applicant_gross_income_summary, :credit, :benefits)).to eq benefits_transactions1
    end

    it "display all the cash transactions for benefits 2" do
      expect(described_class.by_operation_and_category(assessment2.applicant_gross_income_summary, :credit, :benefits)).to eq benefits_transactions2
    end
  end
end
