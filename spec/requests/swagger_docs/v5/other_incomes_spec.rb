    ...
    post("create other_income") do
      ...
      response(422, "Unprocessable Entity") do
        ...
        run_test! do |response|
          ...
          expect(body[:errors]).to include(/The property '#\/other_incomes\/0\/source' value "foobar" did not match one of the following values: benefits, friends_or_family, maintenance_in, property_or_lodger, pension, Benefits, Friends or family, Maintenance in, Property or lodger, Pension/)
        end
      end
    end
  end
