        ...
        let(:params) do
          {
            ...
            dependants: [
              attributes_for(:dependant, relationship: "child_relative", in_full_time_education: true, amount: 0, frequency: "monthly", date_of_birth: "2015-02-11").except(:amount, :frequency),
            ],
            employment_income: [
              {
                name: "Job 1",
