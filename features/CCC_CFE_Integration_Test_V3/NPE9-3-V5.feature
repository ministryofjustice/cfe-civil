Feature:
    ...
    Pensioner capital disregard is applied. Outcome: eligible, no contribution required"
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And I add other income "friends_or_family" of ["700 600 600 500 700 500"]; with bespoke dates ["2019-05-15 2019-05-01 2019-04-17 2019-04-03 2019-03-20 2019-03-06"]
