Feature:
    ...
    They receive income from cash transactions. They do not own property, but do have some valuable assets.
    Outcome: income and capital contribution required. "

  Scenario: Test that the correct output is produced for the following set of data.
    Given I am undertaking a certificated assessment
    And A submission date of "2019-05-29"
    And A domestic abuse case
    And I add "friends_or_family" cash_transactions_income of 1278.01 per month
    And I add "rent_or_mortgage" cash_transactions of 700 per month
