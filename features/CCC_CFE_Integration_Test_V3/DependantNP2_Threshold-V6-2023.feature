Feature:
    ...
    The client has 1 child dependants and 1 adult dependants (one of which has income) and post 10th April 2023 rates applied.
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And I have a dependant aged 25 with monthly income of 340 and capital 7999
    ...
    Then I should see the following "disposable_income_summary" details:
      | attribute                      | value  |
      | dependant_allowance            | 338.9  |
      | total_outgoings_and_allowances | 538.9  |
      | total_disposable_income        | 461.1  |
