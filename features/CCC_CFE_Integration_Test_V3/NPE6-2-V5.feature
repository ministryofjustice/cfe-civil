Feature:
    ...
    Pensioner capital disregard is applied, but does not result in a deduction as the income is too high.
    Outcome: capital and income contribution required. "
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And I have a dependant aged 30 with monthly income of 0 and capital 1000
    And I have a dependant aged 32 with monthly income of 200 and capital 7999
    ...
    Then I should see the following "capital summary" details:
      ...
      | assessed_capital            | 101500.0|
      | capital_contribution        | 98500.0 |
    Then I should see the following "disposable_income_summary" details:
      | attribute                      | value  |
      | dependant_allowance            | 1257.45|
      | total_outgoings_and_allowances | 1307.45|
      | total_disposable_income        | 324.22 |
