Feature:
    ...
    The client has 1 child dependants and 1 adult dependants (one of which has income) and post 12th April 2020 rates applied.
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And A submission date of "2021-04-12"
    And A domestic abuse case
    And I have a dependant aged 13
    And I have a dependant aged 34 with monthly income of 315 and capital 7999
    ...
    Then I should see the following "disposable_income_summary" details:
      ...
      | total_outgoings_and_allowances | 498.08 |
      | total_disposable_income        | 501.92 |
