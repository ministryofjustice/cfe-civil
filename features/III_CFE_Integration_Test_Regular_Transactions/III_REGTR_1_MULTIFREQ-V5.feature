Feature:
  ...
  The client has 1 child dependant, student loan income, other regular incomes/outgoings at varying frequencies and friends or family ‘cash’ income.
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    Then I should see the following "disposable_income_summary" details:
      ...
      | total_outgoings_and_allowances |  2075.85 |
      | total_disposable_income        | -1262.96 |
