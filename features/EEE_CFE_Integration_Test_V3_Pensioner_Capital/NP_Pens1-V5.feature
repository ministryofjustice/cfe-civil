Feature:
  "Checks that a pensioner capital disregard of £60,000 is applied. 
  This is because the client is over 60, in receipt of a passporting benefit and
  have a disposable income of £119.22 per month."
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And I add multiple outgoing details including "rent_or_mortgage" of 255 per month, with bespoke dates: "2019-05-15" "2019-04-15" "2019-03-15"
    And I add multiple outgoing details including "child_care" of 200 per month, with bespoke dates: "2019-05-15" "2019-04-15" "2019-03-15"
    ...
    Then I should see the following "disposable_income_summary" details:
      ...
      | gross_housing_costs            |   255.0 |
      | housing_benefit                |     0.0 |
      | net_housing_costs              |   255.0 |
      | total_outgoings_and_allowances | 1512.45 |
      | total_disposable_income        |  119.22 |
