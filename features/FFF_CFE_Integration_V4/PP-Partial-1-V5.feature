Feature:
    ...
    The capital is over the upper threshold therefore the overall result is partially eligible
    and capital contributions are required for the DA proceedings."
