Feature:
    ...
    The capital is below the upper threshold therefore the overall result is capital contributions required."
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    And I add the following proceeding types in the current assessment:
      ...
      | SE013     | A                       |
      | SE003     | A                       |
    And I add 7999.0 capital of type "bank_accounts"
    ...
    Then I should see the following "capital summary" details:
      | attribute                   | value   |
      | total_capital               | 7999.0  |
      | total_liquid                | 7999.0  |
      | total_non_liquid            |    0.0  |
      | total_vehicle               |    0.0  |
      | pensioner_capital_disregard |    0.0  |
      | assessed_capital            | 7999.0  |
      | capital_contribution        | 4999.0  |
