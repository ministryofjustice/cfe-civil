Feature:
    ...
    The disposable income and capital is over the thresholds therefore the overall result,
    is partially eligible and income and capital contributions are required for the DA proceedings."
  ...
  Scenario: Test that the correct output is produced for the following set of data.
    ...
    Then I should see the following "capital summary" details:
      ...
      | assessed_capital            | 9000.0 |
      | capital_contribution        | 6000.0 |
