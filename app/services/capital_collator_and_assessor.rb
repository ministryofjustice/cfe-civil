class CapitalCollatorAndAssessor
  class << self
    def call(proceeding_types:, submission_date:, level_of_help:, capitals_data:, date_of_birth:, receives_qualifying_benefit:, total_disposable_income:)
      pensioner_capital_disregard = pensioner_capital_disregard(submission_date:, date_of_birth:,
    ...
    def partner(proceeding_types:, submission_date:, level_of_help:, capitals_data:, partner_capitals_data:, date_of_birth:, partner_date_of_birth:,
      ...
      pensioner_capital_disregard = partner_pensioner_capital_disregard(submission_date:, date_of_birth:, partner_date_of_birth:,
                                                                        receives_qualifying_benefit:, total_disposable_income:)
      applicant_subtotals = collate_applicant_capital(submission_date:,
                                                      level_of_help:, pensioner_capital_disregard:,
                                                      capitals_data:)
