module Decorators
  module V6
    class CapitalResultDecorator
      def initialize(person_capital_subtotals)
      ...
      def as_json
        {
          ...
          total_liquid: @person_capital_subtotals.other_assets_handler.total_liquid.to_f,
          total_non_liquid: @person_capital_subtotals.other_assets_handler.total_non_liquid.to_f,
          total_vehicle: @person_capital_subtotals.vehicle_subtotals.total_vehicle.to_f,
          total_property: @person_capital_subtotals.property_subtotals.total_property.to_f,
          total_mortgage_allowance: @person_capital_subtotals.property_subtotals.total_mortgage_allowance.to_f,
