module Decorators
  module V6
    class DisposableIncomeResultDecorator
      def initialize(employment_income_subtotals, disposable_income_subtotals:)
      ...
      def as_json
        {
          ...
          gross_housing_costs: @disposable_income_subtotals.housing_costs.to_f,
          housing_costs: @disposable_income_subtotals.housing_costs.to_f,
          housing_benefit: @disposable_income_subtotals.housing_benefit.to_f,
          net_housing_costs: @disposable_income_subtotals.allowed_housing_costs.to_f,
          allowed_housing_costs: @disposable_income_subtotals.allowed_housing_costs.to_f,
