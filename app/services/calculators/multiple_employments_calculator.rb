module Calculators
  class MultipleEmploymentsCalculator
    class << self
      def call(submission_date)
        ...
        EmploymentIncomeCalculator::EmploymentResult.new(
          employment: DummyEmploymentFigures.new(0, 0, 0, 0, 0),
    ...
    private
      ...
      DummyEmploymentFigures = Data.define(:monthly_gross_income, :monthly_benefits_in_kind, :monthly_tax, :monthly_national_insurance, :actively_working?)
