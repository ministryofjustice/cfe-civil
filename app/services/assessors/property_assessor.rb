      ...
      def call(submission_date:, properties:, level_of_help:, smod_cap:)
        ...
        (properties.select(&:main_home) + properties.reject(&:main_home)).map do |property|
          ...
          smod_disregard = if property.subject_matter_of_dispute
                             ...
                             Disregard.new(result: calculator_result.net_equity, applied: 0)
                           end
          ...
          Result.new(transaction_allowance: calculator_result.transaction_allowance,
                     net_value: calculator_result.net_value,
                     net_equity: calculator_result.net_equity,
